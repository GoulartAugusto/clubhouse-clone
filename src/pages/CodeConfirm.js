...
export default function CodeConfirm() {
    return (
        <div className={style.phoneConfirmContainer}>
            <Link exat to='/get_username' className={style.backBtn}>
                <img src="images/arrow.png" alt="" />
            </Link>
            <div className="text-name">
                <h1 style={{width: "100%", maxWidth: "200px", marginBottom: '1em', textAlign: 'center'}}>Enter the code we jut texted you</h1>
